...
"[project]/app/api/highlights/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getHighlightPath(bookUrl) {
    ...
    const bookDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].dirname(safeUrl);
    return __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', bookDir, 'highlights.json');
}
async function GET(req) {
    try {
        ...
        for (const highlightPath of pathsToCheck){
            if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(highlightPath)) {
                try {
                    const fileContent = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(highlightPath, 'utf-8');
                    const fileHighlights = JSON.parse(fileContent);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allHighlights);
    } catch (error) {
...
async function POST(req) {
    try {
        const newHighlight = await req.json();
        ...
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(highlightPath, JSON.stringify(highlights, null, 2));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            highlights
        });
...
async function DELETE(req) {
    try {
        ...
        if (!bookUrl) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'bookUrl is required for deletion'
            }, {
                status: 400
            });
        }
        const highlightPath = getHighlightPath(bookUrl);
        if (!highlightPath || !__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(highlightPath)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "No highlight file found"
            });
        }
        const fileContent = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(highlightPath, 'utf-8');
        let highlights = JSON.parse(fileContent);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e64c7ec9._.js.map